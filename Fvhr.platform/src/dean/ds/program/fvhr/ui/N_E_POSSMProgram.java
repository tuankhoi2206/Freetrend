 ...
 * DD *
 */
public class N_E_POSSMProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new N_E_POSSMDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		// 4.<資料瀏覽欄位>
		return new String[] { "EMPSN", "ID_POSS", "ID_POSS_LEVEL", "TIME_B",
				"TIME_E", "NOTE" };
	}
}
