...
import ds.program.fvhr.domain.N_N_EMP_POSS;
...
public class N_E_POSSMDataContent extends DataContent {
	...
	private SelectField ID_POSS_DscField2;

	private nextapp.echo2.app.Label ID_POSS_LEVEL_CaptionLabel;

	private SelectField ID_POSS_LEVEL_DscField3;

	private nextapp.echo2.app.Label TIME_B_CaptionLabel;

	private dsc.echo2app.component.DscDateField TIME_B_DscDateField1;

	private nextapp.echo2.app.Label TIME_E_CaptionLabel;

	private dsc.echo2app.component.DscDateField TIME_E_DscDateField2;
	...
	/**
	 * Creates a new <code>N_E_POSSMDataContent</code>.
	 */
	public N_E_POSSMDataContent() {
		super();

		objUtil = new OBJ_UTILITY();
		System.out.println(objUtil.AutoGenKey());
	...
	public void saveUIToDataObject() {
		...
		// 使用者可在以下區域填入控制欄位數值
		// N_N_EMP_POSS data = (N_N_EMP_POSS) getDataObject();
	}
	 ...
	 * //使用者可以在以下區域撰寫產生新序號的程式碼並將新序號放入dataObject //N_N_EMP_POSS data =
	 * (N_N_EMP_POSS) getDataObject(); //Connection conn =
	 ...
	 * "N_N_EMP_POSS", "{ID_FIELD}", // keys, filters, // true, false);
	 * 
	...
	private void registPropertyEditor() {
		...
		this.getUIDataObjectBinder().registerCustomEditor(N_N_EMP_POSS.class,
				"TIME_B", PropertyEditors.createDateEditor("dd/MM/yyyy"));
		this.getUIDataObjectBinder().registerCustomEditor(N_N_EMP_POSS.class,
				"TIME_E", PropertyEditors.createDateEditor("dd/MM/yyyy"));
		this.getUIDataObjectBinder().registerCustomEditor(N_N_EMP_POSS.class,
				"ID_POSS_LEVEL", objUtil.Get_Editor_Level());
		this.getUIDataObjectBinder().registerCustomEditor(N_N_EMP_POSS.class,
				"ID_POSS", objUtil.Get_Editor_ID_POSS());
	}
	...
	private void bindUI() {
		...
		getUIDataObjectBinder().addBindMap("EMPSN", EMPSN_DscField1,
				EMPSN_CaptionLabel);
		getUIDataObjectBinder().addBindMap("ID_POSS", ID_POSS_DscField2,
				ID_POSS_CaptionLabel);
		getUIDataObjectBinder().addBindMap("ID_POSS_LEVEL",
				ID_POSS_LEVEL_DscField3, ID_POSS_LEVEL_CaptionLabel);
		getUIDataObjectBinder().addBindMap("TIME_B", TIME_B_DscDateField1,
				TIME_B_CaptionLabel);
		getUIDataObjectBinder().addBindMap("TIME_E", TIME_E_DscDateField2,
				TIME_E_CaptionLabel);
		getUIDataObjectBinder().addBindMap("NOTE", NOTE_DscField4,
				NOTE_CaptionLabel);
		// 以上為自動產生的程式碼，請勿修改此區域內之程式碼-------------------------------------------
		// ----------------------------------------------------------------------------------
	}
	...
	protected void doNewDefaulData() {
		...
		// data.setID_POSS(Obj_Utility.AutoGenKey());
	...
	private void initComponents() {
		...
		EMPSN_CaptionLabel.setText("N_N_EMP_POSS.EMPSN");
		...
		ID_POSS_CaptionLabel.setText("N_N_EMP_POSS.ID_POSS");
		rootLayout.add(ID_POSS_CaptionLabel);
		ID_POSS_DscField2 = new SelectField();
		ID_POSS_DscField2.setId("ID_POSS_DscField2");
		ID_POSS_DscField2.setSelectedIndex(0);
		ID_POSS_DscField2.setWidth(new Extent(160));
		rootLayout.add(ID_POSS_DscField2);

		ID_POSS_LEVEL_CaptionLabel = new nextapp.echo2.app.Label();
		ID_POSS_LEVEL_CaptionLabel.setText("N_N_EMP_POSS.ID_POSS_LEVEL");
		rootLayout.add(ID_POSS_LEVEL_CaptionLabel);
		ID_POSS_LEVEL_DscField3 = new SelectField();
		ID_POSS_LEVEL_DscField3.setId("ID_POSS_LEVEL_DscField3");
		ID_POSS_LEVEL_DscField3.setSelectedIndex(0);
		ID_POSS_LEVEL_DscField3.setWidth(new Extent(160));
		rootLayout.add(ID_POSS_LEVEL_DscField3);

		TIME_B_CaptionLabel = new nextapp.echo2.app.Label();
		TIME_B_CaptionLabel.setText("N_N_EMP_POSS.TIME_B");
		rootLayout.add(TIME_B_CaptionLabel);
		TIME_B_DscDateField1 = new dsc.echo2app.component.DscDateField();
		TIME_B_DscDateField1.setId("TIME_B_DscDateField1");
		TIME_B_DscDateField1.setDateFormat(OBJ_UTILITY.Get_format_date());
		rootLayout.add(TIME_B_DscDateField1);

		TIME_E_CaptionLabel = new nextapp.echo2.app.Label();
		TIME_E_CaptionLabel.setText("N_N_EMP_POSS.TIME_E");
		rootLayout.add(TIME_E_CaptionLabel);
		TIME_E_DscDateField2 = new dsc.echo2app.component.DscDateField();
		TIME_E_DscDateField2.setId("TIME_E_DscDateField2");
		TIME_E_DscDateField2.setDateFormat(OBJ_UTILITY.Get_format_date());
		rootLayout.add(TIME_E_DscDateField2);

		NOTE_CaptionLabel = new nextapp.echo2.app.Label();
		NOTE_CaptionLabel.setText("N_N_EMP_POSS.NOTE");
