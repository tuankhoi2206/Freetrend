 ...
 * BB *
 */
public class N_POSSMProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new N_POSSMDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		// 4.<資料瀏覽欄位>
		return new String[] { "ID_POSS", "ID_POSS_LEVEL", "DATE_B", "DATE_E",
				"MONEY", "NAME_POSS", "NOTE" };
	}
}
