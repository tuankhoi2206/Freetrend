 ...
 * ATT * 
 */
public class ATT00MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new ATT00MDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		//4.<資料瀏覽欄位>
        return new String[] {"EMPSN", "EMPNA", "DEPSN"};
	}
}
