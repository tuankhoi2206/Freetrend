...
public class TrainingDetail01MQuery extends QueryNormal2 {
	...
	@Override
	public TrainingDetail01MProgram getProgram() {
		return (TrainingDetail01MProgram) super.getProgram();
	}
