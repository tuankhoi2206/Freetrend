 ...
 * MonHoc * 
 */
public class MonHoc00MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new MonHoc00MDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		//4.<資料瀏覽欄位>
        return new String[] {"MA_MON_HOC", "TEN_MON_HOC"};
	}
}
