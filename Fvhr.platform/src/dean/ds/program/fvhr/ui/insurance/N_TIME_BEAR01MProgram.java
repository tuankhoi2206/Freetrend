 ...
 * N_TIME_BEAR01M * 
 */
public class N_TIME_BEAR01MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new N_TIME_BEAR01MDataContent());
	}
	...
	protected QueryPane createNormalQuery() {
		return new N_TIME_BEAR01MQuery();
	}
	...
	protected String[] getBrowserDisplayColumns() {
		//4.<資料瀏覽欄位>
        //return null;
		return new String[]{"EMPSN","BB_DATES","EE_DATES","NOTE","DATES_BEAR","DATES_GKS"};
	}
}
