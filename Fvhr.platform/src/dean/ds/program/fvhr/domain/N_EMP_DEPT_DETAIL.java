...
import ds.program.fvhr.domain.pk.N_EMP_DEPT_DETAILPk;
...
* 
**/
@IdClass(N_EMP_DEPT_DETAILPk.class)
@Entity
@Table(name = "N_EMP_DEPT_DETAIL")
public class N_EMP_DEPT_DETAIL {
    ...
    @NotBlank
    @Column(name = "EMPSN")
    @Config(key = "N_EMP_DEPT_DETAIL.EMPSN")
    ...
    @NotBlank
    @Column(name = "ID_DEPT")
    @Config(key = "N_EMP_DEPT_DETAIL.ID_DEPT")
    ...
    @Column(name = "DATE_B")
    @Config(key = "N_EMP_DEPT_DETAIL.DATE_B")
    ...
    @Temporal(TemporalType.DATE)
    @Column(name = "DATE_E")
    @Config(key = "N_EMP_DEPT_DETAIL.DATE_E")
    ...
    @Length(max = 100)
    @Column(name = "USER_UP")
    @Config(key = "N_EMP_DEPT_DETAIL.USER_UP")
    ...
    @Temporal(TemporalType.DATE)
    @Column(name = "DATE_UP")
    @Config(key = "N_EMP_DEPT_DETAIL.DATE_UP")
