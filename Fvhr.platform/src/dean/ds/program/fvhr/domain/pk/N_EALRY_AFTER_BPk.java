...
@Embeddable
public class N_EALRY_AFTER_BPk implements Serializable {
    private java.lang.String EMPSN;
    private java.util.Date BB_DATES;
    private java.util.Date EE_DATES;
    public N_EALRY_AFTER_BPk() {
        super();
    }
    public N_EALRY_AFTER_BPk(java.lang.String EMPSN, java.util.Date BB_DATES, java.util.Date EE_DATES) {
        super();
        this.EMPSN = EMPSN;
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof N_EALRY_AFTER_BPk))
            return false;
        N_EALRY_AFTER_BPk castOther = (N_EALRY_AFTER_BPk) other;
