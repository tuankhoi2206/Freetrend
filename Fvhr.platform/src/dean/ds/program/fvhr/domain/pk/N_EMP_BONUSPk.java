...
@Embeddable
public class N_EMP_BONUSPk implements Serializable {
    private java.lang.String EMPSN;
    private java.util.Date DATE_EFFECT;
    public N_EMP_BONUSPk() {
        super();
    }
    public N_EMP_BONUSPk(java.lang.String EMPSN, java.util.Date DATE_EFFECT) {
        super();
        this.EMPSN = EMPSN;
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof N_EMP_BONUSPk))
            return false;
        N_EMP_BONUSPk castOther = (N_EMP_BONUSPk) other;
