...
@Embeddable
public class ATTENDANTDB_QUITPk implements Serializable {
	...
	public ATTENDANTDB_QUITPk() {
		super();
	}

	public ATTENDANTDB_QUITPk(java.lang.String EMPSN, java.util.Date DOT_TV) {
		super();
		this.EMPSN = EMPSN;
		this.DOT_TV = DOT_TV;
	}
	...
	public boolean equals(final Object other) {
		if (!(other instanceof ATTENDANTDB_QUITPk))
			return false;
		ATTENDANTDB_QUITPk castOther = (ATTENDANTDB_QUITPk) other;
