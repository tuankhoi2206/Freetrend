 ...
 * Rest_Detail * 
 */
public class Rest_Detail_01MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new Rest_Detail_01MDataContent());
	}
	...
	protected QueryPane createNormalQuery() {
		return new Rest_Detail_01MQuery();
	}
	...
	protected String[] getBrowserDisplayColumns() {
		//4.<資料瀏覽欄位>
        return new String[] {"EMPSN", "DATE_OFF","TOTAL","REST_KIND","REST_TYPE","TIN","TOUT","MID_TIME","NOTE","NOTE1"};
	}
}
