...
public class DeptUserControl extends Row {
	...
	public DeptUserControl() {
		InitComponent();
	}
	
	public DeptUserControl(boolean vbleEmpsnRow,boolean vbleDateRow){
		InitComponent();
	...
	public void   refresh()
	{
		this.sf_fact.setSelectedIndex(-1);
		this.sf_group.setSelectedIndex(-1);
		this.cb_dept.setText("");
		this.tf_date.setText("-- Chọn ngày --");
