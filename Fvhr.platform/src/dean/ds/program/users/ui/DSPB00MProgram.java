 ...
 * DSPB00 *
 */
public class DSPB00MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new DSPB00MDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		// 4.<資料瀏覽欄位>
		return new String[] { "PB_ID", "PB_NA", "PB_PRG" };
	}
}
