 ...
 * DSPB02 *
 */
public class DSPB02MProgram extends MaintainSProgram {
	...
	protected void createDataContent() {
		setMasterDataContent(new DSPB02MDataContent());
	}
	...
	protected String[] getBrowserDisplayColumns() {
		// 4.<資料瀏覽欄位>
		return new String[] { "PB_USERID", "PB_NAME", "PB_CNAME" };
	}
}
